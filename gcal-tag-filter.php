 ...
 */
define( 'GCAL_TAG_FILTER_VERSION', '1.0.19' );
 ...
 * Core plugin classes.
 */
require_once GCAL_TAG_FILTER_PATH . 'includes/class-gcal-capabilities.php';
...
function gcal_tag_filter_activate() {
    ...
    // Setup capabilities
    GCal_Capabilities::setup_default_capabilities();
