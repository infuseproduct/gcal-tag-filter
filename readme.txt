...
= 1.0.25 =
* Fixed multi-day events not appearing on all days they span in month and week views (JS navigation)
* Fixed multi-day events not appearing in all months they span in year view (JS navigation)
